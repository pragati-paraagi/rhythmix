...
class AuthRemoteRepository {
  ...
  Future<Either<AppFailure, UserModel>> login({
    ...
    return Right(UserModel.fromMap(resBodyMap['user']).copyWith(token: resBodyMap['token'], favorites: null));
  ...
  Future<Either<AppFailure, UserModel>> getCurrentUserData(String token)async {
    ...
    return Right(UserModel.fromMap(resBodyMap['user']).copyWith(token: token, favorites: null));
